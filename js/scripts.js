class BoxShadowGenerator {
    ...
    applyRule(){
        ...
        const shadowRule = `${this.inset.checked ? "inset" : ""} ${this.horizontal.value}px ${this.vertical.value}px ${this.blur.value}px ${this.spread.value}px rgba(${rgbValue}, ${this.opacityRef.value})`;
...
rulesArea.addEventListener("click", () => {
    ...
    setTimeout(() => {
        copyInstructions.innerText = "Clique na regra para copiar!";
    }, 1000)
})